  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-[960px] px-6 py-10 animate-fade-in">
        ...
        {runs.length > 0 && (
          <div className="rounded-xl border border-zinc-100 bg-white overflow-hidden dark:border-zinc-800 dark:bg-zinc-900">
            {runs.map((run, i) => (
              <div
                key={run.id}
                className={`flex items-center gap-4 px-4 py-3 transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-800 ${
              ...
              >
                ...
                >
                  <p className="truncate text-[13px] font-medium text-zinc-800 dark:text-zinc-200 hover:text-[#2754C5] transition-colors">
                    {run.title}
                  </p>
        ...
        {runs.length === 0 && (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <svg className="h-8 w-8 text-zinc-200 dark:text-zinc-700 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12.75V12A2.25 2.25 0 014.5 9.75h15A2.25 2.25 0 0121.75 12v.75m-8.69-6.44l-2.12-2.12a1.5 1.5 0 00-1.061-.44H4.5A2.25 2.25 0 002.25 6v12a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9a2.25 2.25 0 00-2.25-2.25h-5.379a1.5 1.5 0 01-1.06-.44z" />
            </svg>
            <p className="text-[13px] text-zinc-400 dark:text-zinc-500 mb-4">
