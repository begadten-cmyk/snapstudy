  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-[960px] px-6 py-10 animate-fade-in">
        {/* Header */}
        <div className="mb-10">
          <h1 className="text-[22px] font-semibold tracking-tight text-zinc-900 mb-1">
        ...
        <div className="grid gap-4 sm:grid-cols-2 mb-10">
          <Link
            ...
            className="group rounded-xl border border-zinc-200/80 bg-white p-5 transition-all hover:border-zinc-300 hover:shadow-sm"
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h2 className="text-[15px] font-semibold text-zinc-900 group-hover:text-[#2754C5] transition-colors">
                  Quick Scan
                </h2>
              </div>
            </div>
            ...
            <div className="mt-3 text-[11px] font-medium text-zinc-400 group-hover:text-[#2754C5] transition-colors">
              Speed mode &rarr;
            </div>
          </Link>
        ...
        {recent.length > 0 && (
          <div className="animate-fade-in-delay-2">
            <div className="flex items-center justify-between mb-3">
              ...
              <Link href="/library" className="text-[11px] font-medium text-zinc-400 hover:text-zinc-600 transition-colors">
                View all &rarr;
              </Link>
            </div>
        ...
        {/* Privacy note */}
        <p className="mt-12 text-[11px] leading-relaxed text-zinc-300">
